        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            if (user) {
              ...
              (0, (_log || _load_log()).default)((_chalk || _load_chalk()).default.underline('iOS devices') + ': run ' + (_chalk || _load_chalk()).default.bold('exp send -s <your-email-address>') + ' in this project directory in another terminal window to send the URL to your device.');
