...
function validateAlphaChannelIsEmpty(data, _ref3) {
  ...
  for (var y = 0; y < height; y++) {
    for (var x = 0; x < width; x++) {
      var idx = (width * y + x) * 4;
      if (data[idx + 3] !== 255) {
        throw new (_xdl || _load_xdl()).XDLError((_xdl || _load_xdl()).ErrorCode.INVALID_ASSETS, 'Your application icon can\'t have transparency if you wish to upload your app to Apple Store.');
      }
    }
  }
}
