...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (projectDir, { projectName, projectDescription, projectEntryPoint }) {
    ...
    yield (_jsonFile || _load_jsonFile()).default.writeAsync(expJsonTargetPath, expJson);
    console.log('Wrote exp.json');

    // Add entry point and dependencies to package.json
    let unsupportedPackagesUsed = [];
    let packageJson = yield (_jsonFile || _load_jsonFile()).default.readAsync(packageJsonSourcePath);
    ...
    yield (_jsonFile || _load_jsonFile()).default.writeAsync(packageJsonTargetPath, packageJson);
    console.log('Updated package.json');

    // TODO: Add import Expo from 'expo'; at the top of main file
    // Copy babelrc
    yield (_jsonFile || _load_jsonFile()).default.writeAsync(babelRcTargetPath, (_babelrc || _load_babelrc()).default);
