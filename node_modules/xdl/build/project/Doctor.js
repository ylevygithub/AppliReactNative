...
exports.getExpoSdkStatus = exports.EXPO_SDK_NOT_IMPORTED = exports.EXPO_SDK_NOT_INSTALLED = exports.EXPO_SDK_INSTALLED_AND_IMPORTED = exports.validateWebPlatformAddedAsync = exports.validateWebSupportAsync = exports.hasWebSupportAsync = exports.validateWithNetworkAsync = exports.validateLowLatencyAsync = exports.validateWithSchema = exports.validateWithSchemaFileAsync = exports.FATAL = exports.ERROR = exports.WARNING = exports.NO_ISSUES = undefined;
...
let _validateExpJsonAsync = (() => {
  var _ref5 = _asyncToGenerator(function* (exp, pkg, projectRoot, allowNetwork) {
    ...
    const expJsonExists = yield (_config || _load_config()).fileExistsAsync(_path.default.join(projectRoot, 'exp.json'));
    const appJsonExists = yield (_config || _load_config()).fileExistsAsync(_path.default.join(projectRoot, 'app.json'));
    ...
    let sdkVersions = yield (_Versions || _load_Versions()).sdkVersionsAsync();
    if (!sdkVersions) {
...
let _validateNodeModulesAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (projectRoot) {
    ...
    try {
      (_config || _load_config()).resolveModule('react-native/local-cli/cli.js', projectRoot, exp);
...
let hasWebSupportAsync = exports.hasWebSupportAsync = (() => {
  var _ref10 = _asyncToGenerator(function* (projectRoot, exp) {
    let inputExp = exp;
    if (!exp) {
      inputExp = (yield (_ProjectUtils || _load_ProjectUtils()).readConfigJsonAsync(projectRoot)).exp;
    }
  ...
  return function hasWebSupportAsync(_x23, _x24) {
    return _ref10.apply(this, arguments);
  };
})();

let validateWebSupportAsync = exports.validateWebSupportAsync = (() => {
  var _ref11 = _asyncToGenerator(function* (projectRoot) {
    const isInteractive = process.stdout.isTTY;

    yield validateWebPlatformAddedAsync(projectRoot, isInteractive);

    // TODO: Bacon: Add package validation
  });

  return function validateWebSupportAsync(_x25) {
    return _ref11.apply(this, arguments);
  };
})();

let validateWebPlatformAddedAsync = exports.validateWebPlatformAddedAsync = (() => {
  var _ref12 = _asyncToGenerator(function* (projectRoot, isInteractive = true) {
    const hasWebSupport = yield hasWebSupportAsync(projectRoot);
    if (hasWebSupport) {
      return true;
    }

    if (isInteractive && (yield promptToAddWebPlatform())) {
      yield (_config || _load_config()).addPlatform(projectRoot, 'web');
      return true;
    }
    throw new (_XDLError || _load_XDLError()).default((_ErrorCode || _load_ErrorCode()).default.WEB_NOT_CONFIGURED, getWebSetupLogs());
  });

  return function validateWebPlatformAddedAsync(_x26) {
...
let promptAsync = (() => {
  var _ref13 = _asyncToGenerator(function* (message) {
    ...
    const { should } = yield (_inquirer || _load_inquirer()).default.prompt(question);
    return should;
  });

  return function promptAsync(_x27) {
    return _ref13.apply(this, arguments);
  };
})();

let promptToAddWebPlatform = (() => {
  var _ref14 = _asyncToGenerator(function* () {
    return yield promptAsync(`It appears you don't explicitly define "${(_chalk || _load_chalk()).default.green.underline(`web`)}" as one of the supported "${(_chalk || _load_chalk()).default.green.underline(`platforms`)}" in your project's ${(_chalk || _load_chalk()).default.green(`app.json`)}. \n  Would you like to add it?`);
  });

  return function promptToAddWebPlatform() {
    return _ref14.apply(this, arguments);
  };
})();

let validateAsync = (() => {
  var _ref15 = _asyncToGenerator(function* (projectRoot, allowNetwork) {
  ...
  return function validateAsync(_x28, _x29) {
...
let getExpoSdkStatus = exports.getExpoSdkStatus = (() => {
  ...
  return function getExpoSdkStatus(_x30) {
...
function getWebSetupLogs() {
  const appJsonRules = (_chalk || _load_chalk()).default.green(`
  {
    "platforms": [
  ${(_chalk || _load_chalk()).default.green.bold(`+      "web"`)}
    ]
  }`);
  return `${(_chalk || _load_chalk()).default.red(`* Add "web" to the "platforms" array in your project's ${(_chalk || _load_chalk()).default.bold(`app.json`)}`)} ${appJsonRules}`;
}
