...
let getSlugAsync = exports.getSlugAsync = (() => {
  var _ref9 = _asyncToGenerator(function* (projectRoot, options = {}) {
    ...
    if (!exp || !pkg) {
      const configName = yield (_config || _load_config()).configFilenameAsync(projectRoot);
...
let publishAsync = exports.publishAsync = (() => {
  var _ref17 = _asyncToGenerator(function* (projectRoot, options = {}) {
    ...
    // Get project config
    let { exp, pkg } = yield _getPublishExpConfigAsync(projectRoot, options);
...
let _uploadArtifactsAsync = (() => {
  var _ref18 = _asyncToGenerator(function* ({ exp, iosBundle, androidBundle, options, pkg }) {
    ...
    yield Promise.all((0, (_chunk || _load_chunk()).default)(missing, 5).map((() => {
      var _ref32 = _asyncToGenerator(function* (keys) {
        ...
        for (const key of keys) {
          ...
          formData.append(key, (_fsExtra || _load_fsExtra()).default.createReadStream(paths[key]), paths[key]);
        }
...
let getConfigAsync = (() => {
  var _ref33 = _asyncToGenerator(function* (projectRoot, options = {}) {
    if (!options.publicUrl) {
      ...
      return {
        exp,
        pkg,
        configName: yield (_config || _load_config()).configFilenameAsync(projectRoot),
  ...
  return function getConfigAsync(_x67) {
...
let buildAsync = exports.buildAsync = (() => {
  ...
  return function buildAsync(_x68) {
...
let _waitForRunningAsync = (() => {
  ...
  return function _waitForRunningAsync(_x69, _x70) {
...
let startReactNativeServerAsync = exports.startReactNativeServerAsync = (() => {
  var _ref36 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    ...
    let packagerOpts = {
      port: packagerPort,
      customLogReporterPath: (_config || _load_config()).resolveModule('expo/tools/LogReporter', projectRoot, exp),
      assetExts: ['ttf'],
      nonPersistent: !!options.nonPersistent
    };

    if ((_Versions || _load_Versions()).gteSdkVersion(exp, '33.0.0')) {
      packagerOpts.assetPlugins = (_config || _load_config()).resolveModule('expo/tools/hashAssetFiles', projectRoot, exp);
    }
    ...
    let defaultCliPath = (_config || _load_config()).resolveModule('react-native/local-cli/cli.js', projectRoot, exp);
  ...
  return function startReactNativeServerAsync(_x71) {
...
let stopReactNativeServerAsync = exports.stopReactNativeServerAsync = (() => {
  ...
  return function stopReactNativeServerAsync(_x73) {
...
let startExpoServerAsync = exports.startExpoServerAsync = (() => {
  var _ref39 = _asyncToGenerator(function* (projectRoot) {
    ...
    let manifestHandler = (() => {
      ...
      return function manifestHandler(_x75, _x76) {
  ...
  return function startExpoServerAsync(_x74) {
...
let stopExpoServerAsync = exports.stopExpoServerAsync = (() => {
  ...
  return function stopExpoServerAsync(_x82) {
...
let _connectToNgrokAsync = (() => {
  ...
  return function _connectToNgrokAsync(_x83, _x84, _x85, _x86) {
...
let startTunnelsAsync = exports.startTunnelsAsync = (() => {
  var _ref46 = _asyncToGenerator(function* (projectRoot) {
    ...
    let expRc = yield (_config || _load_config()).readExpRcAsync(projectRoot);
  ...
  return function startTunnelsAsync(_x87) {
...
let stopTunnelsAsync = exports.stopTunnelsAsync = (() => {
  ...
  return function stopTunnelsAsync(_x88) {
...
let setOptionsAsync = exports.setOptionsAsync = (() => {
  ...
  return function setOptionsAsync(_x89, _x90) {
...
let getUrlAsync = exports.getUrlAsync = (() => {
  ...
  return function getUrlAsync(_x91) {
    return _ref53.apply(this, arguments);
  };
})();

let optimizeAsync = exports.optimizeAsync = (() => {
  var _ref54 = _asyncToGenerator(function* (projectRoot = './', options = {}) {
    (_Logger || _load_Logger()).default.global.info((_chalk || _load_chalk()).default.green('Optimizing assets...'));
    const {
      readAssetJsonAsync,
      getAssetFilesAsync,
      optimizeImageAsync,
    ...
    allFiles.forEach(function (image) {
    ...
    outdated.forEach(function (outdatedHash) {
    ...
    if (strQuality !== undefined && !validQuality) {
      (_Logger || _load_Logger()).default.global.warn('Invalid quality entered. Using default of 60.');
    }
    ...
    for (const image of images) {
      ...
      const { size: prevSize } = (_fsExtra || _load_fsExtra()).default.statSync(image);

      const newName = createNewFilename(image);
      yield optimizeImageAsync(image, newName, outputQuality);

      const { size: newSize } = (_fsExtra || _load_fsExtra()).default.statSync(image);
      const amountSaved = prevSize - newSize;
      if (amountSaved < 0) {
        // Delete the optimized version and revert changes
        (_fsExtra || _load_fsExtra()).default.renameSync(newName, image);
        assetInfo[hash] = true;
        (_Logger || _load_Logger()).default.global.info((_chalk || _load_chalk()).default.gray(`Compressed version of ${image} was larger than original. Using original instead.`));
        continue;
      }
      ...
      if (save) {
        if (hash === newHash) {
          (_Logger || _load_Logger()).default.global.info((_chalk || _load_chalk()).default.gray(`Compressed asset ${image} is identical to the original. Using original instead.`));
          (_fsExtra || _load_fsExtra()).default.unlinkSync(newName);
        } else {
          (_Logger || _load_Logger()).default.global.info((_chalk || _load_chalk()).default.gray(`Saving original asset to ${newName}`));
      ...
      (_Logger || _load_Logger()).default.global.info(`Saved ${toReadableValue(amountSaved)}`);
    }
    if (totalSaved === 0) {
      (_Logger || _load_Logger()).default.global.info('No assets optimized. Everything is fully compressed!');
    } else {
      (_Logger || _load_Logger()).default.global.info(`Finished compressing assets. ${(_chalk || _load_chalk()).default.green(toReadableValue(totalSaved))} saved.`);
    }
    assetJson.writeAsync(assetInfo);
  });

  return function optimizeAsync() {
    return _ref54.apply(this, arguments);
  };
})();

let startAsync = exports.startAsync = (() => {
  var _ref55 = _asyncToGenerator(function* (projectRoot, options = {}, verbose = true) {
    _assertValidProjectRoot(projectRoot);
    ...
    if (options.webOnly) {
      yield (_Webpack || _load_Webpack()).startAsync(projectRoot, options, verbose);
    } else {
  ...
  return function startAsync(_x92) {
...
let _stopInternalAsync = (() => {
  var _ref56 = _asyncToGenerator(function* (projectRoot) {
    ...
    yield stopExpoServerAsync(projectRoot);
    yield stopReactNativeServerAsync(projectRoot);
    const hasWebSupport = yield (_Doctor || _load_Doctor()).hasWebSupportAsync(projectRoot);
    if (hasWebSupport) {
      yield (_Webpack || _load_Webpack()).stopAsync(projectRoot);
    }
    if (!(_Config || _load_Config()).default.offline) {
      try {
        yield stopTunnelsAsync(projectRoot);
  ...
  return function _stopInternalAsync(_x93) {
    return _ref56.apply(this, arguments);
  };
})();

let stopAsync = exports.stopAsync = (() => {
  var _ref57 = _asyncToGenerator(function* (projectDir) {
  ...
  return function stopAsync(_x94) {
...
function _load_AssetUtils() {
  return _AssetUtils = _interopRequireWildcard(require('./AssetUtils'));
}
...
function _load_Webpack() {
  return _Webpack = _interopRequireWildcard(require('./Webpack'));
}
...
function _requireFromProject(modulePath, projectRoot, exp) {
  try {
    let fullPath = (_config || _load_config()).resolveModule(modulePath, projectRoot, exp);
