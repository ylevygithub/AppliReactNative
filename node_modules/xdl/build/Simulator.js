...
let _isSimulatorRunningAsync = exports._isSimulatorRunningAsync = (() => {
  var _ref4 = _asyncToGenerator(function* () {
    ...
    if (!bootedDevice) {
      return yield _bootDefaultSimulatorDeviceAsync();
    }
...
let _bootDefaultSimulatorDeviceAsync = (() => {
  var _ref5 = _asyncToGenerator(function* () {
    (_Logger || _load_Logger()).default.global.info(`Booting device in iOS simulator...`);
    try {
      let defaultDeviceUDID = yield _getDefaultSimulatorDeviceUDIDAsync();
      if (!defaultDeviceUDID) {
        defaultDeviceUDID = (yield _getFirstAvailableDeviceAsync()).udid;
      }
      return yield _xcrunAsync(['simctl', 'boot', defaultDeviceUDID]);
    } catch (e) {
      (_Logger || _load_Logger()).default.global.error(`There was a problem booting a device in iOS Simulator. Quit Simulator, and try again.`);
      throw e;
    }
  });

  return function _bootDefaultSimulatorDeviceAsync() {
    return _ref5.apply(this, arguments);
  };
})();

let _getDefaultSimulatorDeviceUDIDAsync = (() => {
  var _ref6 = _asyncToGenerator(function* () {
    try {
      const { stdout: defaultDeviceUDID } = yield (0, (_spawnAsync || _load_spawnAsync()).default)('defaults', ['read', 'com.apple.iphonesimulator', 'CurrentDeviceUDID']);
  ...
  return function _getDefaultSimulatorDeviceUDIDAsync() {
...
let _getFirstAvailableDeviceAsync = (() => {
  var _ref8 = _asyncToGenerator(function* () {
    ...
    (_Logger || _load_Logger()).default.global.warn('No iPhone devices available in Simulator.');
    return null;
  });

  return function _getFirstAvailableDeviceAsync() {
...
let _downloadSimulatorAppAsync = exports._downloadSimulatorAppAsync = (() => {
  var _ref16 = _asyncToGenerator(function* (url) {
...
let _installExpoOnSimulatorAsync = exports._installExpoOnSimulatorAsync = (() => {
  var _ref17 = _asyncToGenerator(function* (url) {
    (_Logger || _load_Logger()).default.global.info(`Downloading the latest version of Expo client app`);
    ...
    (_Logger || _load_Logger()).default.global.info('Installing Expo client on iOS simulator');
    (_Logger || _load_Logger()).default.notifications.info({ code: (_NotificationCode || _load_NotificationCode()).default.START_LOADING });
...
let _uninstallExpoAppFromSimulatorAsync = exports._uninstallExpoAppFromSimulatorAsync = (() => {
  var _ref18 = _asyncToGenerator(function* () {
    try {
      (_Logger || _load_Logger()).default.global.info('Uninstalling Expo client from iOS simulator.');
...
let openUrlInSimulatorSafeAsync = exports.openUrlInSimulatorSafeAsync = (() => {
  var _ref21 = _asyncToGenerator(function* (url, isDetached = false) {
    if (!(yield _isSimulatorInstalledAsync())) {
      return {
        success: false,
