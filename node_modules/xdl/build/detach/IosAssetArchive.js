...
let buildAssetArchiveAsync = (() => {
  var _ref = _asyncToGenerator(function* (context, destinationCARPath, intermediatesDirectory) {
    ...
    (_fsExtra || _load_fsExtra()).default.mkdirpSync(intermediatesDirectory);
    ...
    const sdkMajorVersion = (0, (_ExponentTools || _load_ExponentTools()).parseSdkMajorVersion)(context.data.manifest.sdkVersion);
