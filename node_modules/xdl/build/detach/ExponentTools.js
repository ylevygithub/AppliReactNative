...
let getManifestAsync = (() => {
  var _ref = _asyncToGenerator(function* (url, headers, options = {}) {
    const buildPhaseLogger = options.logger || (_Logger || _load_Logger()).default.withFields({ buildPhase: 'reading manifest' });
