...
exports.createTurtleWorkspaceAsync = exports.configureAndCopyArchiveAsync = exports.buildAndCopyArtifactAsync = exports.EXPONENT_APP = exports.EXPOKIT_APP = undefined;
  ...
  var _ref4 = _asyncToGenerator(function* (args) {
    ...
    if (output) {
      if (type === 'simulator') {
        ...
        yield (0, (_ExponentTools || _load_ExponentTools()).spawnAsync)(`mv ${EXPOKIT_APP}.app ${archiveName}.app && tar -czvf ${output} ${archiveName}.app`, null, {
          stdoutOnly: true,
          pipeToLogger: true,
        ...
        yield (0, (_ExponentTools || _load_ExponentTools()).spawnAsync)('/bin/mv', [`${workspaceName}.xcarchive`, output], {
          pipeToLogger: true,
...
const EXPOKIT_APP = exports.EXPOKIT_APP = 'ExpoKitApp';
const EXPONENT_APP = exports.EXPONENT_APP = 'Exponent';
