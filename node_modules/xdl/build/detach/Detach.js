...
let detachAsync = exports.detachAsync = (() => {
  var _ref2 = _asyncToGenerator(function* (projectRoot, options = {}) {
    let originalLogger = (_Logger || _load_Logger()).default.loggerObj;
    (_Logger || _load_Logger()).default.configure({
      trace: options.verbose ? console.trace.bind(console) : function () {},
      debug: options.verbose ? console.debug.bind(console) : function () {},
      info: options.verbose ? console.info.bind(console) : function () {},
      warn: console.warn.bind(console),
      error: console.error.bind(console),
      fatal: console.error.bind(console)
    });
    try {
      return yield _detachAsync(projectRoot, options);
    } finally {
      (_Logger || _load_Logger()).default.configure(originalLogger);
    }
  });
...
let _detachAsync = (() => {
  var _ref3 = _asyncToGenerator(function* (projectRoot, options) {
    ...
    const { configName, configPath, configNamespace } = yield (_config || _load_config()).findConfigFileAsync(projectRoot);
    ...
    if (!hasIosDirectory && isIosSupported) {
      ...
      if (!exp.ios.bundleIdentifier) {
        (_Logger || _load_Logger()).default.info(`You'll need to specify an iOS bundle identifier. See: https://docs.expo.io/versions/latest/workflow/configuration/#ios`);
    ...
    if (!hasAndroidDirectory) {
      ...
      if (!exp.android.package) {
        (_Logger || _load_Logger()).default.info(`You'll need to specify an Android package name. See: https://docs.expo.io/versions/latest/workflow/configuration/#android`);
        const { androidPackage } = yield (_inquirer || _load_inquirer()).default.prompt([{
          name: 'androidPackage',
          message: 'What would you like your Android package name to be?',
          validate: function (value) {
            return (/^[a-zA-Z][a-zA-Z0-9_]*(\.[a-zA-Z][a-zA-Z0-9_]*)+$/.test(value) ? true : "Invalid format of Android package name (only alphanumeric characters, '.' and '_' are allowed, and each '.' must be followed by a letter)"
            );
          }
        }]);
    ...
    } else if (_process.default.env.EXPO_VIEW_DIR) {
    ...
    if (_process.default.env.EXPO_VIEW_DIR) {
      (_Logger || _load_Logger()).default.info(`Linking 'expokit' package...`);
    ...
    if (packagesToInstall.length) {
      yield (0, (_installPackagesAsync || _load_installPackagesAsync()).default)(projectRoot, packagesToInstall, {
  ...
  return function _detachAsync(_x3, _x4) {
...
let detachIOSAsync = (() => {
  ...
  return function detachIOSAsync(_x5) {
    return _ref4.apply(this, arguments);
  };
})();

let detachAndroidAsync = (() => {
  var _ref5 = _asyncToGenerator(function* (context, expoViewUrl) {
  ...
  return function detachAndroidAsync(_x6, _x7) {
...
let ensureBuildConstantsExistsIOSAsync = (() => {
  ...
  return function ensureBuildConstantsExistsIOSAsync(_x8) {
    return _ref6.apply(this, arguments);
  };
})();

let _getIosExpoKitVersionThrowErrorAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (iosProjectDirectory) {
    let expoKitVersion = '';
  ...
  return function _getIosExpoKitVersionThrowErrorAsync(_x9) {
...
let prepareDetachedBuildIosAsync = (() => {
  ...
  return function prepareDetachedBuildIosAsync(_x10, _x11) {
    return _ref8.apply(this, arguments);
  };
})();

let prepareDetachedServiceContextIosAsync = (() => {
  var _ref9 = _asyncToGenerator(function* (projectDir, args) {
    // service context
  ...
  return function prepareDetachedServiceContextIosAsync(_x12, _x13) {
    return _ref9.apply(this, arguments);
  };
})();

let _readDefaultApiKeysAsync = (() => {
  var _ref10 = _asyncToGenerator(function* (jsonFilePath) {
  ...
  return function _readDefaultApiKeysAsync(_x14) {
    return _ref10.apply(this, arguments);
  };
})();

let prepareDetachedUserContextIosAsync = (() => {
  var _ref11 = _asyncToGenerator(function* (projectDir, exp, args) {
  ...
  return function prepareDetachedUserContextIosAsync(_x15, _x16, _x17) {
...
let prepareDetachedBuildAsync = exports.prepareDetachedBuildAsync = (() => {
  var _ref12 = _asyncToGenerator(function* (projectDir, args) {
    if (args.platform === 'ios') {
      ...
      let expoBuildConstantsMatches = yield (0, (_globPromise || _load_globPromise()).default)(androidProjectDirectory + '/**/DetachBuildConstants.java');
  ...
  return function prepareDetachedBuildAsync(_x18, _x19) {
    return _ref12.apply(this, arguments);
  };
})();

let bundleAssetsAsync = exports.bundleAssetsAsync = (() => {
  var _ref13 = _asyncToGenerator(function* (projectDir, args) {
  ...
  return function bundleAssetsAsync(_x20, _x21) {
...
var _installPackagesAsync;

function _load_installPackagesAsync() {
  return _installPackagesAsync = _interopRequireDefault(require('./installPackagesAsync'));
}
