...
let extractTemplateApp = exports.extractTemplateApp = (() => {
  var _ref2 = _asyncToGenerator(function* (templateSpec, projectRoot, packageManager = 'npm', config = {}) {
    ...
    let tarStream = yield (_pacote || _load_pacote()).default.tarball.stream(templateSpec, {
      cache: _path.default.join((_UserSettings || _load_UserSettings()).default.dotExpoHomeDirectory(), 'template-cache')
    });
    yield (_fsExtra || _load_fsExtra()).default.mkdirp(projectRoot);
    yield new Promise(function (resolve, reject) {
      const extractStream = (_tar || _load_tar()).default.x({
        cwd: projectRoot,
        strip: 1,
    ...
    let appJson = (0, (_merge || _load_merge()).default)((yield appFile.readAsync()), config);
    ...
    yield initGitRepoAsync(projectRoot);
    yield installDependenciesAsync(projectRoot, packageManager);

    return projectRoot;
  });

  return function extractTemplateApp(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
})();

let initGitRepoAsync = (() => {
  ...
  return function initGitRepoAsync(_x4) {
    return _ref3.apply(this, arguments);
  };
})();

let installDependenciesAsync = (() => {
  ...
  return function installDependenciesAsync(_x5, _x6) {
...
let saveRecentExpRootAsync = exports.saveRecentExpRootAsync = (() => {
  ...
  return function saveRecentExpRootAsync(_x7) {
...
let expInfoSafeAsync = exports.expInfoSafeAsync = (() => {
  ...
  return function expInfoSafeAsync(_x8) {
...
let getThirdPartyInfoAsync = exports.getThirdPartyInfoAsync = (() => {
  ...
  return function getThirdPartyInfoAsync(_x9) {
...
let getPublishInfoAsync = exports.getPublishInfoAsync = (() => {
  var _ref8 = _asyncToGenerator(function* (root) {
    ...
    const configName = yield (_config || _load_config()).configFilenameAsync(root);
  ...
  return function getPublishInfoAsync(_x10) {
...
let sendAsync = exports.sendAsync = (() => {
  ...
  return function sendAsync(_x11, _x12) {
...
let getProjectRandomnessAsync = exports.getProjectRandomnessAsync = (() => {
  ...
  return function getProjectRandomnessAsync(_x13) {
...
let resetProjectRandomnessAsync = exports.resetProjectRandomnessAsync = (() => {
  ...
  return function resetProjectRandomnessAsync(_x14) {
...
function _load_minipass() {
  return _minipass = _interopRequireDefault(require('minipass'));
}
...
class Transformer extends (_minipass || _load_minipass()).default {
  constructor(config) {
    super();
    this.data = '';
    this.config = config;
