...
exports.generateUploadKeystore = exports.createKeystore = exports.logKeystoreHashes = exports.exportPrivateKey = exports.exportCertBase64 = exports.exportCertBinary = exports.backupExistingCredentials = undefined;
...
let exportCertBinary = exports.exportCertBinary = (() => {
  ...
  return function exportCertBinary(_x2, _x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
})();

let exportCertBase64 = exports.exportCertBase64 = (() => {
  var _ref3 = _asyncToGenerator(function* (keystorePath, keystorePassword, keyAlias, certFile) {
    return (0, (_spawnAsync || _load_spawnAsync()).default)('keytool', ['-export', '-rfc', '-keystore', keystorePath, '-storepass', keystorePassword, '-alias', keyAlias, '-file', certFile, '-noprompt', '-storetype', 'JKS']);
  });

  return function exportCertBase64(_x6, _x7, _x8, _x9) {
    return _ref3.apply(this, arguments);
  };
})();

let exportPrivateKey = exports.exportPrivateKey = (() => {
  var _ref4 = _asyncToGenerator(function* ({ keystorePath, keystorePassword, keyAlias, keyPassword }, encryptionKey, outputPath, log = (_Logger || _load_Logger()).default.info.bind((_Logger || _load_Logger()).default)) {
    let nodePty;
  ...
  return function exportPrivateKey(_x10, _x11, _x12) {
    return _ref4.apply(this, arguments);
  };
})();

let logKeystoreHashes = exports.logKeystoreHashes = (() => {
  var _ref5 = _asyncToGenerator(function* ({ keystorePath, keystorePassword, keyAlias }, log = (_Logger || _load_Logger()).default.info.bind((_Logger || _load_Logger()).default)) {
    const certFile = `${keystorePath}.cer`;
    try {
      yield exportCertBinary(keystorePath, keystorePassword, keyAlias, certFile);
  ...
  return function logKeystoreHashes(_x13) {
    return _ref5.apply(this, arguments);
  };
})();

let createKeystore = exports.createKeystore = (() => {
  var _ref6 = _asyncToGenerator(function* ({ keystorePath, keystorePassword, keyAlias, keyPassword }, androidPackage) {
  ...
  return function createKeystore(_x14, _x15) {
    return _ref6.apply(this, arguments);
  };
})();

let generateUploadKeystore = exports.generateUploadKeystore = (() => {
  var _ref7 = _asyncToGenerator(function* (uploadKeystorePath, androidPackage, experienceName) {
    const keystoreData = {
  ...
  return function generateUploadKeystore(_x16, _x17, _x18) {
