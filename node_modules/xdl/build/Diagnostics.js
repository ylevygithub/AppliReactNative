...
let _uploadLogsAsync = (() => {
  var _ref = _asyncToGenerator(function* (info) {
    ...
    let username = user ? user.username : (_User2 || _load_User2()).ANONYMOUS_USERNAME;
    ...
    formData.append('archive', (_fsExtra || _load_fsExtra()).default.createReadStream(archivePath));
